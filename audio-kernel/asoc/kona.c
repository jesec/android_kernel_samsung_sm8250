				...
				struct snd_pcm_hw_params *params)
{
	...
	case MSM_BACKEND_DAI_SLIMBUS_7_TX:
		#ifdef VENDOR_EDIT
		/*Zhao.Pan@PSW.MM.AudioDriver.Machine.2549861 , 2019/11/28
		 *Add control route "MultiMedia17 Mixer SLIM_7_TX" for bt-sco record */
		param_set_mask(params, SNDRV_PCM_HW_PARAM_FORMAT,
...
static int msm_mi2s_snd_startup(struct snd_pcm_substream *substream)
{
	...
	if (++mi2s_intf_conf[index].ref_cnt == 1) {
		...
		#ifdef VENDOR_EDIT
		/*Jianfeng.Qiu@PSW.MM.AudioDriver.Codec, 2019/07/15,
...
static const struct snd_soc_dapm_widget msm_int_dapm_widgets[] = {
	...
	#ifdef VENDOR_EDIT
	/*Jianfeng.Qiu@PSW.MM.AudioDriver.Platform, 2019/07/15,
	 *Add for new digital mic widgets.
	 */
...
static struct snd_soc_dai_link msm_wsa_cdc_dma_be_dai_links[] = {
	/* WSA CDC DMA Backend DAI Links */
	{
		...
		.dpcm_playback = 1,
		#ifndef VENDOR_EDIT
		/*Jianfeng.Qiu@PSW.MM.AudioDriver.Machine, 2019/07/03, Delete for no use wsa*/
...
static struct snd_soc_dai_link msm_va_cdc_dma_be_dai_links[] = {
	{
		...
		.dpcm_capture = 1,
		#ifdef VENDOR_EDIT
		/*Jianfeng.Qiu@PSW.MM.AudioDriver.Machine, 2019/07/03, Add for audrx init*/
		.init = &msm_int_audrx_init,
		#endif /* VENDOR_EDIT */
...
static struct snd_soc_card *populate_snd_card_dailinks(struct device *dev)
{
	...
	u32 wcn_btfm_intf = 0;
	#ifdef VENDOR_EDIT
	/*Jianfeng.Qiu@PSW.MM.AudioDriver.Machine, 2019/07/03, Add for wsa*/
	u32 wsa_bolero_codec = 0;
	#endif /* VENDOR_EDIT */
	const struct of_device_id *match;
	#ifdef VENDOR_EDIT
	/*Jianfeng.Qiu@PSW.MM.AudioDriver.Codec, 2019/07/03, Add for codec*/
	int i;
	...
	#ifdef VENDOR_EDIT
	/*Jianfeng.Qiu@PSW.MM.AudioDriver.SmartPA, 2019/08/10, Add for stereo speaker*/
	...
	if (!strcmp(match->data, "codec")) {
		...
		#ifndef VENDOR_EDIT
		/*Jianfeng.Qiu@PSW.MM.AudioDriver.Machine, 2019/07/03, Modify for wsa*/
		memcpy(msm_kona_dai_links + total_links,
		...
		if (rc) {
			...
			if (mi2s_audio_intf) {
				#ifdef VENDOR_EDIT
				/* Jianfeng.Qiu@PSW.MM.AudioDriver.Codec, 2017/01/23,
				* Add for use custom codec dailink replace.
				*/
