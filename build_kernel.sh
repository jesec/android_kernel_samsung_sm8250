...
if [[ ! -z "$4" ]]
then
echo CONFIG_LOCALVERSION=\"-$4\" > arch/arm64/configs/vendor/.release_defconfig
cat arch/arm64/configs/vendor/release_defconfig >> arch/arm64/configs/vendor/.release_defconfig
KERNEL_MAKE_ENV="$KERNEL_MAKE_ENV DEBUG_DEFCONFIG=vendor/.release_defconfig"
fi
