...
#define __GMP_CC "/mnt/storage/gbiv/android/internal-master/prebuilts/gcc/linux-x86/host/x86_64-linux-glibc2.17-4.8.most-recent-old/../x86_64-linux-glibc2.15-4.8/bin/x86_64-linux-gcc -std=gnu99"
